  ...
  return (
    <div className="w-[50rem] rounded-lg bg-white p-16 shadow-xl">
      <div className="flex items-center justify-between">
        <h1 className="flex text-4xl font-black">Subjects</h1>
        <svg
      ...
      <div className="relative">
        <input
          type="text"
          placeholder="Search"
          className="mt-4 w-full rounded-md border border-gray-300 p-2 px-4 py-2 pl-10"
        />
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          ...
          strokeWidth="1.5"
          stroke="currentColor"
          className="absolute left-3 top-7 h-5 w-5"
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
